...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins axi2wb_intcon_wrapper_0/clk_i_wrapper] [get_bd_pins bootrom_wrapper_0/i_clk] [get_bd_pins swerv_wrapper_verilog_0/clk] [get_bd_pins syscon_wrapper_0/i_clk] [get_bd_pins wb_gpio_wrapper_0/wb_clk_i] [get_bd_pins wb_uart_wrapper_0/wb_clk_i]
  ...
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins axi2wb_intcon_wrapper_0/rst_ni_wrapper] [get_bd_pins bootrom_wrapper_0/i_rst] [get_bd_pins swerv_wrapper_verilog_0/rst] [get_bd_pins syscon_wrapper_0/i_rst] [get_bd_pins wb_gpio_wrapper_0/wb_rst_i] [get_bd_pins wb_uart_wrapper_0/wb_rst_i]
