...
set rc [catch {
  ...
  add_files -quiet D:/_Code/verilog/interface_lab/RVfpga_SoC_lab6_edittiming/RVfpga_SoC.runs/synth_1/rvfpga.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source D:/_Code/verilog/script.tcl"
    source D:/_Code/verilog/script.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script D:/_Code/verilog/script.tcl failed"
    return -code error
  }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
