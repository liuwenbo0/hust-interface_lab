...
proc create_root_design { parentCell } {
  ...
  # Create instance: PWM_7digit_v1_0_0, and set properties
  set PWM_7digit_v1_0_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PWM_7digit_v1_0:1.0 PWM_7digit_v1_0_0 ]

  # Create instance: PWM_w_Int_v1_0_0, and set properties
  set PWM_w_Int_v1_0_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PWM_w_Int_v1_0:1.0 PWM_w_Int_v1_0_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins PWM_7digit_v1_0_0/s00_axi] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins PWM_w_Int_v1_0_0/s00_axi] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  ...
  connect_bd_net -net PWM_7digit_v1_0_0_AN [get_bd_ports AN_0] [get_bd_pins PWM_7digit_v1_0_0/AN]
  connect_bd_net -net PWM_7digit_v1_0_0_Digits_Bits [get_bd_ports Digits_Bits_0] [get_bd_pins PWM_7digit_v1_0_0/Digits_Bits]
  connect_bd_net -net PWM_w_Int_v1_0_0_Interrupt_out [get_bd_pins PWM_w_Int_v1_0_0/Interrupt_out] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net PWM_w_Int_v1_0_0_LEDs [get_bd_ports PWMs] [get_bd_pins PWM_w_Int_v1_0_0/LEDs]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins PWM_7digit_v1_0_0/s00_axi_aclk] [get_bd_pins PWM_w_Int_v1_0_0/s00_axi_aclk] [get_bd_pins axi2wb_intcon_wrapper_0/clk_i_wrapper] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins bootrom_wrapper_0/i_clk] [get_bd_pins ptc_wrapper_0/wb_clk_i] [get_bd_pins swerv_wrapper_verilog_0/clk] [get_bd_pins syscon_wrapper_0/i_clk] [get_bd_pins wb_gpio_wrapper_0/wb_clk_i] [get_bd_pins wb_uart_wrapper_0/wb_clk_i]
  ...
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins PWM_7digit_v1_0_0/s00_axi_aresetn] [get_bd_pins PWM_w_Int_v1_0_0/s00_axi_aresetn] [get_bd_pins axi2wb_intcon_wrapper_0/rst_ni_wrapper] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins bootrom_wrapper_0/i_rst] [get_bd_pins ptc_wrapper_0/wb_rst_i] [get_bd_pins swerv_wrapper_verilog_0/rst] [get_bd_pins syscon_wrapper_0/i_rst] [get_bd_pins wb_gpio_wrapper_0/wb_rst_i] [get_bd_pins wb_uart_wrapper_0/wb_rst_i]
  ...
  assign_bd_address -offset 0x80120000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi2wb_intcon_wrapper_0/o_user_axi4] [get_bd_addr_segs PWM_7digit_v1_0_0/s00_axi/reg0] -force
  assign_bd_address -offset 0x80140000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi2wb_intcon_wrapper_0/o_user_axi4] [get_bd_addr_segs PWM_w_Int_v1_0_0/s00_axi/reg0] -force
