...
##set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { pwm_pad_o}];
...
##Temperature Sensor
set_property -dict { PACKAGE_PIN C14   IOSTANDARD LVCMOS33 } [get_ports {temp_sensor_scl_io }]; #IO_L23N_T3_A02_D18_14 Sch=an[7]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports {temp_sensor_sda_io }]; #IO_L23N_T3_A02_D18_14 Sch=an[7]